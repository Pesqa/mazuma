...
const Header = ({ logoImg, isSticky }) => {  
  return(
    <header
    className={isSticky ? "site-header px-3 py-3 position-sticky scrolled bordered" : "site-header px-3 py-3 position-sticky scrolled"}
    >
              ...
              <div className="collapse navbar-collapse" id="mobile-menu">
                <div className="navbar-nav-wrapper">
                  <ul className="navbar-nav main-menu">
                    <li className="nav-item me-2"><a className="nav-link" href="#">Home</a></li>
                    <li className="nav-item me-2"><a className="nav-link" href="#">FAQ</a></li>
                    <li className="nav-item me-2"><a className="nav-link" href="#">Claims</a></li>
                    <li className="nav-item me-2"><a className="nav-link" href="#">Giveback</a></li>
                    <li className="nav-item me-2"><a className="nav-link" href="#">Policy 2.0</a></li>
                    <li className="nav-item me-2 d-lg-none d-md-block"><a className="nav-link text-dark" href="#">My Account</a></li>
                  </ul>
                </div>
              </div>
            </nav>
